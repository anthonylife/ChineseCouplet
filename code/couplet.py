...
from viterbi import ViterbiDecode
...
If you want to exit the program, just input 'q' and enter.\n")
    ...
    optimal_path, prob = ViterbiDecode(hidden_transfer, hidden_visible_transfer, init_pro, [], visible_words, top_k_word)
    ...
    # Output the result
    result = u""
    for i in range(optimal_path.shape[1]):
        result += hidden_candidate_words[optimal_path[0, i], i]
